...
//
//   [2026-08-31 정정] 아래 "상수다" 결론은 틀렸다. measure_baseball_sabr.ts에서 총득점을
//   축으로 다시 자르니 5점 이하 46.8% ~ 10~12점 14.7%로 32%p나 움직인다. 1점차는 상수가
//   아니라, 전력차라는 엉뚱한 축으로 잘라서 평평해 보였던 것이다. 다만 결론(종목을 붙이지
//   않는다)은 다른 이유로 유지된다 - 총득점 자체가 경기 전에 예측이 안 되고(R^2=0.70%),
//   완벽히 안다고 가정해도 승1패 상한이 42.1%다. 자세한 것은 measure_baseball_sabr.ts.
//
